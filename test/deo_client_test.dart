...
void main() {
  ...
  group('DeoClient request cancellation', () {
    test('should cancel requests with the same token', () async {
      // Create a cancel token but use it directly in the test
      // instead of storing it in an unused variable
      ...
      when(mockDio.get<Map<String, dynamic>>(
        ...
        storedToken =
            invocation.namedArguments[Symbol('cancelToken')] as CancelToken?;
